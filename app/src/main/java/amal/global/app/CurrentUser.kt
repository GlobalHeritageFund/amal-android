...
class CurrentUser(var context: Context) {
    ...
    companion object {
        const val PREF_LAST_SELECTED_DB = "last_selected_db"
        const val FIREBASE_DB_IDENTIFIER = "FIREBASE" // Use a constant identifier for Firebase
    }
    ...
    //am switching to uppercase bc in passphrase validator is matching to uppercase
        ...
        //may get a leading comma on string which was creating an extra list item
            val dbPrefString = preferences.getString(databaseTargetsKey, "") ?: ""
